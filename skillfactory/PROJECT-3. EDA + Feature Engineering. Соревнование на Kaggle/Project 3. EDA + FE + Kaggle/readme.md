...
where <span style="font-size: 16px;">$y_{true_i}$</span> are the actual values of the forecast, and <span style="font-size: 16px;">$y_{pred_i}$</span> are the predicted values.
